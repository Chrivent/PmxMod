...
namespace Chrivent {
	...
	GraphicsResult<void> Dx12CommandContext::Initialize(const Dx12Device& sourceDevice) {
		Reset();
	...
	GraphicsResult<void> Dx12CommandContext::BeginFrame(const Dx12Device& sourceDevice,
	...
	GraphicsResult<void> Dx12CommandContext::Execute(const Dx12Device& sourceDevice) {
	...
	GraphicsResult<void> Dx12CommandContext::WaitForGpu(const Dx12Device& sourceDevice) {
