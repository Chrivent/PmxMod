...
namespace Chrivent {
	...
	public:
		ID3D12RootSignature* GetModelRootSignature() const { return info.modelRootSignature.Get(); }
		ID3D12PipelineState* GetModelPipelineState() const { return info.modelPipelineState.Get(); }
