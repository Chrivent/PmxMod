...
namespace Chrivent {
	...
	struct PostProcessInputLayout {
		...
		static constexpr uint32_t frameDataVulkanSet = 0;
		static constexpr uint32_t frameDataVulkanBinding = 0;
		...
		static constexpr uint32_t parameterDataVulkanSet = 1;
		...
		static constexpr uint32_t textureVulkanSet = 2;
		...
		static constexpr uint32_t ResolveSpirvSamplerBinding(const uint32_t slot) { return 4 + slot; }
	};
}
