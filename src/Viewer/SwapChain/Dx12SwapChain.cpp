...
namespace Chrivent {
	GraphicsError::Result<void> Dx12SwapChain::CreateRenderTargetViews(const Dx12Device& sourceDevice) {
	...
	GraphicsError::Result<void> Dx12SwapChain::Initialize(const Dx12Device& sourceDevice,
	...
	GraphicsError::Result<void> Dx12SwapChain::Resize(const Dx12Device& sourceDevice,
	...
	GraphicsError::Result<void> Dx12SwapChain::Present() {
		if (!swapChain) {
			return std::unexpected(GraphicsError::Create(GraphicsApi::DirectX12,
