...
namespace Chrivent {
	...
	public:
		...
		// 애니메이션 대상과 모델 구조가 트랙을 연결한 시점과 같은지 확인한다.
		bool IsBoundTo(const Model& model) const;
