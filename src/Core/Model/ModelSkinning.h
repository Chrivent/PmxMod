...
namespace Chrivent {
	...
	public:
		static std::size_t GetUpdateRangeCount(const Model& model) { return model.geometryData.updateRanges.size(); }
		...
		static void UpdateRange(Model& model, std::size_t rangeIndex);
	};
}
