...
extern "C" {
    ...
    JNIEXPORT jint    JNICALL Java_net_chrivent_pmxstevemod_src_Native_getIndexElementSize(JNIEnv*, jclass, jlong);

    JNIEXPORT jobject JNICALL Java_net_chrivent_pmxstevemod_src_Native_getPositions(JNIEnv*, jclass, jlong);
    JNIEXPORT jobject JNICALL Java_net_chrivent_pmxstevemod_src_Native_getNormals    (JNIEnv*, jclass, jlong);
    JNIEXPORT jobject JNICALL Java_net_chrivent_pmxstevemod_src_Native_getUVs            (JNIEnv*, jclass, jlong);
    JNIEXPORT jobject JNICALL Java_mod_chrivent_pmxstevemod_src_Native_getIndices  (JNIEnv*, jclass, jlong);

    JNIEXPORT jobject JNICALL Java_net_chrivent_pmxstevemod_src_Native_getSubMeshes(JNIEnv*, jclass, jlong);
    JNIEXPORT jobject JNICALL Java_net_chrivent_pmxstevemod_src_Native_getMaterials(JNIEnv*, jclass, jlong);
